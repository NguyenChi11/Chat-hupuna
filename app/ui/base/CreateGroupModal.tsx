...
export default function CreateGroupModal({
  ...
  const [searchTerm, setSearchTerm] = useState(''); // State riêng cho tìm kiếm
  ...
  const groupedUsers = useMemo(() => {
    ...
    return groups;
  }, [allUsers, searchTerm]); // Thêm searchTerm vào dependency
